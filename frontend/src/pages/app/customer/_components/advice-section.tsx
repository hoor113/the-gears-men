...
const AdviceSection = () => {
    const tips = [
        { title: "Cách chọn điện thoại phù hợp", link: "https://www.youtube.com/watch?v=53ZLAOVJrwQ&pp=ygUnQ8OhY2ggY2jhu41uIMSRaeG7h24gdGhv4bqhaSBwaMO5IGjhu6Nw" },
        { title: "So sánh laptop gaming và laptop văn phòng", link: "https://www.youtube.com/watch?v=6Dm1mAj_CGQ&pp=ygUkU28gc8OhbmggbGFwdG9wIGjhu41jIHZzIGzDoG0gdmnhu4dj" },
        { title: "Laptop giá rẻ cho sinh viên", link: "https://www.youtube.com/watch?v=HIeSj7xxUpc&pp=ygUdbGFwdG9wIHNpbmggdmnDqm4gZMawxqFuZyBkw6o%3D" },
    ];
                ...
                {tips.map((tip, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Typography variant="subtitle1" className="font-semibold mb-2 group-hover:text-indigo-700 transition-colors">
                                {tip.title}
                            </Typography>
                            <a  
                                target="_blank"
