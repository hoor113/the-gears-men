...
export default function CustomerTopNav() {
    ...
    let currentCartState = cartState;
    useEffect(() => {
    ...
    const handleCartItemRemove = (id: any) => {
        ...
        currentCartState.items = currentCartState.items.filter((item) => item.id !== id);
            ...
            <div className="flex items-center gap-x-4 w-2/3">
                ...
                <ClickAwayListener onClickAway={handleSearchBlur}>
                    <div className="relative w-1/2 ml-8">
                        ...
                        {searchResultOpen && debouncedKeyword && getAllAccessories?.length > 0 && (
                            <Paper
                                elevation={4}
                                sx={{
                                    position: 'absolute',
                            ...
                            >
                                {getAllAccessories.map((product: any) => {
                                    ...
                                    const mainPrice = hasDiscount ? product.priceAfterDiscount : product.price;
            ...
            <div className="flex items-center gap-x-4">
                ...
                >
                    <IconButton color="inherit">
                        <Badge badgeContent={totalItems} color="warning" className="hover:cursor-pointer">
                            <ShoppingCartIcon />
                        </Badge>
                    </IconButton>
                        ...
                        <List>
                            {categoriesObject.map((category) => (
                                <ListItem key={category.key} disablePadding>
                                    <ListItemButton onClick={() => navigate(`/category/${category.key}`)}>
