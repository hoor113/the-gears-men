...
import SuccessPage from '@/pages/app/payment/_services/success/index.page';
import SuccessLayout from '@/pages/app/payment/_services/success/layout';
import FailPage from '@/pages/app/payment/fail/index.page';
import FailLayout from '@/pages/app/payment/fail/layout';
import CheckoutPage from '@/pages/app/payment/page';
