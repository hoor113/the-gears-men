...
const OwnerVoucherPage = () => {
    ...
    const { data: vouchers = [], isLoading, isFetching } = useQuery<any>({
    ...
    return (
        <Box p={2}>
            ...
            <Box
                ...
                mb={2}
            >
                <Button variant="contained" color="primary" onClick={() => NiceModal.show(AddDiscountCodeModal, {
            ...
            <Grid container spacing={2}>
                <Grid item xs={12} md={4}>
                    <Paper elevation={3} sx={{ p: 2 }}>
                        ...
                        <Box>
                            <Typography variant="subtitle1" mb={1}>Loại mã giảm giá</Typography>
                            <RadioGroup
                                value={filterType}
                        ...
                        <Box mt={2}>
                            <Typography variant="subtitle1" mb={1}>Phương thức giảm</Typography>
                            <RadioGroup
                                value={filterMethod}
