...
import PersonnelLeftDrawer from './left-drawer';
...
export default function PersonnelTopNav() {
    ...
    return (
        <div className="w-full bg-[#ece2df] px-4  md:px-10 py-3 flex justify-between items-center gap-y-3 text-white relative">
            ...
            <div className="flex items-center gap-x-4 w-2/3">
                ...
                >
                    <span className="top-nav-group-name">
                        The Gears Men
                    </span>
                </Typography>
            </div>
            ...
            <div className="flex items-center gap-x-4">
                ...
                />
                <PersonnelLeftDrawer drawerOpen={drawerOpen} toggleDrawer={toggleDrawer} />
            </div>
        </div>
    );
}